...
namespace Ground_Handlng.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signInManager, ApplicationDbContext db, IETRoleManager _roleManager, IETUserManager _userManager, IEmailSender _emailSender, IHttpContextAccessor accessor, IUserService userService, ITokenManager tokenManager, IActionDescriptorCollectionProvider provider)
        {
            _provider = provider;
            _accessor = accessor;
